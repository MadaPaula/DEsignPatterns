...
public class ComandaReparatieMecanica implements IComandaReparatie {
    private double cost;
    private Defectiune defectiune;

    private AHandler specialist;

    public ComandaReparatieMecanica(double cost, Defectiune defectiune, AHandler specialist) {
        this.cost = cost;
    ...
    public String toString() {
        return "Tip reparatie: Mecanica, Cost: " + cost;
    }
}
